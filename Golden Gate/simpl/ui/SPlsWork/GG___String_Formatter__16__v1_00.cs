...
namespace UserModule_GG___STRING_FORMATTER__16__V1_00
{
    public class UserModuleClass_GG___STRING_FORMATTER__16__V1_00 : SplusObject
    {
    ...
    public override void LogosSplusInitialize()
    {
        ...
        ENABLE = new InOutArray<DigitalOutput>( 16, this );
        for( uint i = 0; i < 16; i++ )
        {
        ...
        IN__DOLLAR__ = new InOutArray<StringInput>( 16, this );
        for( uint i = 0; i < 16; i++ )
        {
        ...
        OUT__DOLLAR__ = new InOutArray<StringOutput>( 16, this );
        for( uint i = 0; i < 16; i++ )
        {
    ...
    public UserModuleClass_GG___STRING_FORMATTER__16__V1_00 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
